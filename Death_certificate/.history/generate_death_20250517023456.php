...
<body>
    <div class="certificate">
        ...
        <!-- Official Section with Stamp and Signature -->
        <div class="official-section">
            <!-- Official Stamp on the Left -->
            <div class="official-stamp">
                <div class="stamp-image">
                    <img src="images/official_stamp.png" alt="Official Stamp">
                </div>
                <p>Official Seal</p>
            </div>
            ...
            <div class="stamp-area">
                ...
                <div style="margin: 30px 0; border-top: 1px solid #000; width: 200px;"></div>

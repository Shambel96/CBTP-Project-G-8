...
<body>
    ...
    <style>
        /* Additional styles for the image stamp */
        .official-stamp {
            position: absolute;
            left: 50px;
            bottom: 50px;
    ...
    <div class="certificate">
        <!-- ... [keep all your existing certificate content] ... -->
        
        <!-- Official Stamp with Image -->
        <div class="official-stamp">
            <img src="images/kebele_stamp.png" alt="Official Kebele Stamp" class="stamp-image">
